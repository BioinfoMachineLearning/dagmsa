...
perl $hhblits_dir/scripts/addss_v2020.pl $multicom_tool_dir $multicom_database_dir $work_dir/$nameA.fasta.a3m $work_dir/$nameA.fasta.ss.a3m -a3m
...
#For second MSA
perl $hhblits_dir/scripts/addss_v2020.pl $multicom_tool_dir $multicom_database_dir $work_dir/$nameB.fasta.a3m $work_dir/$nameB.fasta.ss.a3m -a3m
