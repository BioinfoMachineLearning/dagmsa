...
my $bioprogs_dir="/data/farhan/multicom4s/tool/multicom4s_TMB/tools_"  #"/exports/store2/casp14/tools";          # see next two lines
my $biodb_dir = "/exports/store2/casp14/databases";
...
my $ncbidir="$bioprogs_dir/blast-2.2.17/bin";             # Put the directory path with the BLAST executables 
my $hh="$bioprogs_dir/hhblits/bin";                         # Put the directory path with hhfilter and hhmake
my $perl="$bioprogs_dir/hhblits/scripts";                     # Put the directory path where reformat.pl is lying
...
my $dummydb="$biodb_dir/uniref/uniref90"; # Put the name given to the dummy blast directory (or leave this name)
...
my $psipreddir="$bioprogs_dir/psipred-2.61/";        # Put the directory path with the PSIPRED executables 
...
use lib "/exports/store2/casp14/tools/hhblits/scripts";
use Align;
...
my $informat="a3m";    # input format/data/farhan/multicom4s/tool/multicom4s_TMB/
