...
#usage: python combineSS_a3m.py <alignment_A> <alignment_B> <outdir>
...
if (True):
        ...
        if os.path.exists(tmpdir+"pairs_AB.fasta.ss.a3m"): os.remove(tmpdir+"pairs_AB.fasta.ss.a3m")
        ...
        with open (tmpdir+"pairs_AB.fasta.ss.a3m","w") as fa3m:
            for pair in pairs_AB:
                fa3m.write(">"+pair[0]+"_"+pair[1]+"\n")
                fa3m.write(dict_A[pair[0]].strip()+dict_B[pair[1]].strip()+"\n")

shutil.copy2(tmpdir+"pairs_AB.fasta.ss.a3m",outdir+name_A+"_"+name_B+".fasta.ss.a3m")
