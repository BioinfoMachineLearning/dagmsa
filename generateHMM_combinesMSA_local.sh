...
fastafolder=/data/farhan/HETERO_STD/fastas
filename=$( basename "/data/farhan/multicom4s/tool/multicom4s_TMB/test_msas/1A1MA_1A1MB.a3m") 
filename="${filename%.*}"
splits=$(echo $filename| tr "_" "\n")
outdir=/data/farhan/multicom4s/tool/multicom4s_TMB/hmm_test
...
do
    ...
    echo "perl $hhblits_dir/scripts/addss_v2020.pl $multicom_tool_dir $multicom_database_dir $work_dir/$names.a3m $work_dir/$names.ss.a3m -a3m"
